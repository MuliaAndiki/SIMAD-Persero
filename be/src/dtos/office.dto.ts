...
export const OfficeQueryDto = t.Object({
  ...
  keyword: t.Optional(t.String({ description: 'Kata kunci pencarian (name/address)' })),
  departmentId: t.Optional(t.String({ description: 'Filter berdasarkan departemen' })),
});
...
export const UpdateOfficeDto = t.Partial(
  t.Object({
    departmentIds: t.Array(t.String({ description: 'ID departemen (banyak-ke-banyak)' })),
    name: t.String({
      minLength: 1,
      maxLength: 150,
      description: 'Nama lokasi kantor',
