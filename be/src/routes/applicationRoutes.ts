...
class ApplicationRouter {
  ...
  private routes() {
    ...
    this.applicationRouter.post(
      "/",
      (c: AppContext) => applicationController.create(c),
      {
        beforeHandle: [
    ...
    this.applicationRouter.patch(
      "/:id",
      (c: AppContext) => applicationController.updateDraft(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
          requireRole(["INTERN"]).beforeHandle,
    ...
    this.applicationRouter.post(
      "/:id/submit",
      (c: AppContext) => applicationController.submit(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
          requireRole(["INTERN"]).beforeHandle,
    ...
    this.applicationRouter.post(
      "/:id/cancel",
      (c: AppContext) => applicationController.cancel(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
          requireRole(["INTERN"]).beforeHandle,
    ...
    this.applicationRouter.delete(
      "/:id",
      (c: AppContext) => applicationController.deleteDraft(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
          requireRole(["INTERN"]).beforeHandle,
    ...
    this.applicationRouter.get(
      "/",
      (c: AppContext) => applicationController.list(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
    ...
    // 14.7 GET /applications/:id — Application detail (HR_ADMIN, SUPERVISOR)
    this.applicationRouter.get(
      "/:id",
      (c: AppContext) => applicationController.getById(c),
      {
        beforeHandle: [
          verifyToken().beforeHandle,
