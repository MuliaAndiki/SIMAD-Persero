...
class UserRouter {
  ...
  private routes() {
    ...
    this.userRouter.patch(
      "/profile",
      (c: AppContext) => UserController.updateProfile(c),
      {
        ...
        detail: {
          summary: "Ubah profil",
          description:
            "Memperbarui profil pengguna. Email dan role tidak dapat diubah.",
          tags: ["User"],
        },
      },
    );
    ...
    this.userRouter.post(
      "/profile/photo",
      (c: AppContext) => UserController.uploadPhoto(c),
      {
        ...
        detail: {
          ...
          description:
            "Upload foto profil JPG/JPEG/PNG maksimal 5 MB. Foto lama diganti.",
          tags: ["User"],
        },
      },
    );
    ...
    this.userRouter.patch(
      "/change-password",
      (c: AppContext) => UserController.changePassword(c),
      {
        ...
        detail: {
          ...
          description:
            "Mengubah password pengguna yang sedang login (oldPassword + newPassword).",
          tags: ["User"],
        },
      },
    );
