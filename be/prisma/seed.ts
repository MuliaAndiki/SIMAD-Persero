...
const INSTITUTIONS = [
  {
    ...
    city: "Depok",
    educationCode: "S1",
    majors: ["Teknik Informatika", "Ilmu Komputer", "Sistem Informasi"],
  },
  {
    ...
    city: "Bandung",
    educationCode: "S1",
    majors: ["Teknik Informatika", "Sistem Informasi", "Teknik Industri"],
  },
  {
    ...
    city: "Yogyakarta",
    educationCode: "S1",
    majors: ["Ilmu Komputer", "Teknik Elektro"],
  },
  {
    ...
    city: "Jakarta",
    educationCode: "S1",
    majors: ["Sistem Informasi", "Manajemen Informatika"],
  },
  {
    ...
    city: "Depok",
    educationCode: "D3",
    majors: ["Teknik Informatika", "Akuntansi"],
  },
  {
    name: "SMK Negeri 1 Jakarta",
    shortName: "SMKN 1 JKT",
    province: "DKI Jakarta",
    city: "Jakarta",
    educationCode: "SMK",
    majors: ["Rekayasa Perangkat Lunak", "Multimedia"],
  },
] as const;
