...
import { CheckCircle2, LayoutDashboard, Loader2, RefreshCw, XCircle } from 'lucide-react';

export type MagicLinkStatus = 'verifying' | 'success' | 'error';

export interface MagicLinkSectionProps {
  state: {
...
export function MagicLinkSection({ state, service }: MagicLinkSectionProps) {
