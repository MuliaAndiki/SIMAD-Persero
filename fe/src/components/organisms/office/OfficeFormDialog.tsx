...
export function OfficeFormDialog({
  ...
  return (
    <FormDialogShell
      open={open}
      title={isEdit ? 'Edit Kantor' : 'Tambah Kantor'}
      description="Lengkapi informasi lokasi kantor. Klik peta untuk memilih titik koordinat absensi."
      isEdit={isEdit}
      isSaving={isSaving}
      canSubmit={canSubmit}
      onClose={onClose}
      onSubmit={onSubmit}
      maxWidthClass="max-h-[85vh] overflow-y-auto sm:max-w-lg"
    >
