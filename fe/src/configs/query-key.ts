...
export const queryKey = {
  ...
  department: {
    list: (query?: Record<string, any>) =>
      ["department", "list", query] as const,
    detail: (departmentId: string) =>
      ["department", "detail", departmentId] as const,
  },
  ...
  application: {
    ...
    list: (query?: Record<string, any>) =>
      ["application", "list", query] as const,
  ...
  internship: {
    ...
    list: (query?: Record<string, any>) =>
      ["internship", "list", query] as const,
    profile: () => ["internship", "profile"] as const,
    skills: (query?: Record<string, any>) =>
      ["internship", "skills", query] as const,
  ...
  institution: {
    list: (query?: Record<string, any>) =>
      ["institution", "list", query] as const,
    detail: (institutionId: string) =>
      ["institution", "detail", institutionId] as const,
  },
  ...
  attendance: {
    ...
    summary: (query?: Record<string, any>) =>
      ["attendance", "summary", query] as const,
    supervisor: () => ["attendance", "supervisor"] as const,
    history: (query?: Record<string, any>) =>
      ["attendance", "history", query] as const,
    export: (query?: Record<string, any>) =>
      ["attendance", "export", query] as const,
  ...
  certificate: {
    verify: (verificationCode: string) =>
      ["certificate", "verify", verificationCode] as const,
    my: () => ["certificate", "my"] as const,
    detail: (certificateId: string) =>
      ["certificate", "detail", certificateId] as const,
  },

  notificationRoot: () => ["notification"] as const,
  notification: {
    list: (query?: Record<string, any>) =>
      ["notification", "list", query] as const,
  ...
  supervisor: {
    ...
    list: (query?: Record<string, any>) =>
      ["supervisor", "list", query] as const,
    detail: (supervisorId: string) =>
      ["supervisor", "detail", supervisorId] as const,
  },

  reportingRoot: () => ["reporting"] as const,
  reporting: {
    attendance: (query?: Record<string, any>) =>
      ["reporting", "attendance", query] as const,
