...
const domains = [
  {
    ...
    typeFile: '@/types/api/application.types',
    array: true,
  ...
  },
  {
    ...
    typeFile: '@/types/api/attendance.types',
    array: true,
  ...
  },
  {
    ...
    typeFile: '@/types/api/certificate.types',
    array: true,
  ...
  },
  {
    ...
    typeFile: '@/types/api/department.types',
    array: true,
  ...
  },
  {
    name: 'File',
    model: 'FileResponse',
    typeFile: '@/types/api/file.types',
    array: true,
    query: 'fileRoot()',
  }, // no list method typically for File
  {
    name: 'Internship',
    model: 'InternshipResponse',
    typeFile: '@/types/api/internship.types',
    array: true,
    query: 'internship.my()',
  },
  {
    ...
    typeFile: '@/types/api/notification.types',
    array: true,
  ...
  },
  {
    ...
    typeFile: '@/types/api/office.types',
    array: true,
    query: 'office.list()',
  },
  {
    name: 'Supervisor',
    model: 'SupervisorAssignmentResponse',
    typeFile: '@/types/api/supervisor.types',
    array: true,
